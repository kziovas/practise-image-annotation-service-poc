...
class TestCommentModel:
    def test_comment_model_creation(self, new_comment):
        assert new_comment.id is not None
        assert new_comment.body == "Test comment"
        assert new_comment.user_id is not None
        assert new_comment.image_id is not None

    def test_comment_model_update_body(self, new_comment):
        new_body = "Updated comment"
        new_comment.body = new_body
        assert new_comment.body == new_body
